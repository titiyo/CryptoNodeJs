...
module.exports.createCertificateByCA = createCertificateByCA;
module.exports.exportCertificateToMail = exportCertificateToMail;
 ...
 */
function createPrivateKey(encrypt, keyFileName, password, keyBitsize, callback){
    ...
    if(password != null && password != undefined && password != ''){
        ...
        if(encrypt != null && keyFileName != undefined){
            params.push("-" + encrypt);
        }
    }

    if(keyFileName != null && keyFileName != undefined){
        params.push("-out");
        params.push(keyFileName + ".key");
    }  
...
function createCSR(options, callback){
    ...
    {
        params.push("-out");
        params.push(options.outCsr + ".csr");
    }
...
function createCertificateByCA(options, callback){
    if(!callback && typeof options == "function"){
        callback = options;
        options = undefined;
    }
    ...
    params.push("-out");
    params.push("./MyCertificate/" + options.out + ".crt");


    execOpenSSL(params, "CERTIFICATE", function(error, data){
        if(error){
            return callback(error);
        }
...
function exportCertificateToMail(options, callback){
    if(!callback && typeof options == "function"){
        callback = options;
        options = undefined;
    }
